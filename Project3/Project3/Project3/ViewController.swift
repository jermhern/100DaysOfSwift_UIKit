...
class ViewController: UITableViewController {
    ...
    @objc func shareApp() {
        ...
        let url = URL(string: "https://apps.apple.com/us/app/foodswipr/id1581852879")
        
        // Create UIActivityViewController
        let vc = UIActivityViewController(activityItems: ["Share Storm Viewer with friends!", url!], applicationActivities: [])
        
        // Show more context to iPad users for where the share is coming from
